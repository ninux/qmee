...
lambda	= 50;			      % [nm]  pulse wavelength
sigma		= 30;			      % [nm]  pulse width
...
n_step	= 1;
count   = 0;    
nos     = 3*del_x/3^8/dt;  % number of timestepts between plots (equidistant)
...
while nop > count
    ...
    set(gca, "fontsize", 10);
    if (count == 0)
      title("Exercise 3-1 b - 1D FDTD Simulation");
    else
      title(" ");
    endif
